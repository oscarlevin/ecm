...
\item\label{task-209} \hypertarget{p-1094}{}%
Find \(S(3,1)\), \(S(4,1)\) and \(S(k,1)\).%
\item\label{task-210} \hypertarget{p-1095}{}%
Compute \(S(2,2)\), \(S(3,2)\) and \(S(4,2)\).  Find a formula for \(S(k,2)\) and prove it is correct.%
\item\label{task-211} \hypertarget{p-1096}{}%
Compute \(S(3,3)\), and \(S(4,3)\).%
\item\label{task-212} \hypertarget{p-1097}{}%
