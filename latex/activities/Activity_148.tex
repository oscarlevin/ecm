...
\item\label{task-182} \hypertarget{p-963}{}%
...
~\hfill{\tiny\hyperlink{a-148.a}{[hint]}\hypertarget{q-148.a}{}}\item\label{task-183} \hypertarget{p-965}{}%
Show that if \(\alpha\) and \(\beta\) are any constants, \(a_n = \alpha 2^n + \beta 3^n\) is also a solution to the recurrence relation.%
\item\label{task-184} \hypertarget{p-966}{}%
