...
\theoremstyle{ptxplainnotitle}
\newtheorem{conjecturenotitle}[cthm]{Conjecture}
\theoremstyle{ptxplaintitle}
\newtheorem{conjecturetitle}[cthm]{Conjecture}
\NewDocumentEnvironment{conjecture}{ot+o}
    { \IfBooleanTF{#2}
        { \IfValueTF{#1}{ \begin{conjecturetitle}[#3 {\mdseries(#1)}] }{ \begin{conjecturetitle}[#3]} } 
        { \IfValueTF{#1}{ \begin{conjecturenotitle}[#1]  }{ \begin{conjecturenotitle}} }
    }
    { \IfBooleanTF{#2}{\end{conjecturetitle}}{\end{conjecturenotitle}} }
...
\newtheorem{cpjt}{BadProjectNameString}\theoremstyle{ptxdefinitionnotitle}
...
\theoremstyle{ptxdefinitionnotitle}
\newtheorem{investigationnotitle}[cpjt]{Puzzle}
\theoremstyle{ptxdefinitiontitle}
\newtheorem{investigationtitle}[cpjt]{Puzzle}
\NewDocumentEnvironment{investigation}{o}
  {\IfValueTF{#1}{\begin{investigationtitle}[#1]}{\begin{investigationnotitle}}}
  {\IfValueTF{#1}{\end{investigationtitle}}{\end{investigationnotitle}}}
